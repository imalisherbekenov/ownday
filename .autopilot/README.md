...
- `dashboard.html` — открывается сам в начале сборки; можно и двойным кликом.
  ...
  `index.html` рядом — тот же дашборд под коротким адресом. Отдельно его открывать не нужно.
...
|---|---|---|---|
| 2026-08-23 | `2026-08-23-telegram-mini-app` | сдан | Приложение открывается внутри Telegram и узнаёт человека само; бот предлагает вход, когда появится адрес |
